...
# 배경 이미지 불러오기
background = pygame.image.load("F:/코딩\파이썬 기초/나도코딩 활용1/pygame_basic/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("F:/코딩\파이썬 기초/나도코딩 활용1/pygame_basic/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("F:/코딩\파이썬 기초/나도코딩 활용1/pygame_basic/enemy.png")
